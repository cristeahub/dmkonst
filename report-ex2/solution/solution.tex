...
\todo{Write about same-cycle write-reads?}
...
In the presented architecture, there are separate instruction fetch, decode, execution, memory access and register writeback stages.
